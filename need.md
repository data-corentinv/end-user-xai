...
end-users' requirements in different explanation need scenarios. 
...
3.  **The ability to discriminate similar instances** This information
    ...
    > *"([Decision tree](explanatory_form.md#dt)) It's showing me that it's
    ...
    > *"[Typical example](explanatory_form.md#te) seems to be pretty good
    at picking up on differences. [Similar
    example](explanatory_form.md#) I can see that it's got a good
...
trust were [performance](explanatory_form.md#performance)
(20/40), [output](explanatory_form.md#output) (20/40), and [feature
attribute](explanatory_form.md#fa) (17/40). 
...
([feature attribute](explanatory_form.md#fa), 9/13):

> *"It shows how it detects the important objects and how it makes
decision"* 

> *"See if (the [feature attributes](explanatory_form.md#fa)) align with my
own judgment of feature importance."*

[Performance](explanatory_form.md#performance) (6/13) were also favourable to
check the metrics summary of performance. A specified
[performance](explanatory_form.md#performance) analysis in different test
...
[Similar example](explanatory_form.md#se) (7/13) were preferred since it
...
tree](explanatory_form.md#dt) (6/13) because it *"gave me an overview of
...
A fine-grained [performance](explanatory_form.md#performance) (12/24) analysis
...
Participants chose [similar](explanatory_form.md#se) + [typical
example](explanatory_form.md#te) (12/24, means out of the 24
card-selection responses on [Bias](#bias), 12 selected
either [similar](explanatory_form.md#se) or [typical
example](explanatory_form.md#te)) to help inspect the data and model, and
...
[Feature attribute](explanatory_form.md#fa) (12/24) was also chosen since
...
[Feature attribute](explanatory_form.md#fa): 28/61

[similar example](explanatory_form.md#se): 25/61

[decision tree](explanatory_form.md#dt): 23/61

[performance](explanatory_form.md#performance): 20/61
...
[Feature attribute](explanatory_form.md#fa): 13/34

[similar example](explanatory_form.md#se): 12/34

[typical example](explanatory_form.md#te): 10/34
...
[Rule](explanatory_form.md#rl) (12/14) and [counterfactual
example](explanatory_form.md#ce) (10/14) were the most preferable forms.
Participants chose [rule](explanatory_form.md#rl) since *"you could write
that you differentiated the bird's tail were long or short, or beak thin
or thick"*. The [counterfactual examples](explanatory_form.md#ce)
...
Rule-based explanations ([rule](explanatory_form.md#rl): 12/14, [decision
flow chart](explanatory_form.md#dt): 10/14, [decision
tree](explanatory_form.md#dt): 8/14) were more favourable for the need to
...
see this one ([feature attribute](explanatory_form.md#fa)), I think, 'oh
...
> *"I know it ([feature interaction](explanatory_form.md#fi)) is comparing
...
### Preferred explanatory forms
[Counterfactual
example](explanatory_form.md#ce) (18/26) and [feature
shape](explanatory_form.md#fs) (13/26) were the top two selected forms.
While [counterfactual example](explanatory_form.md#ce) provides
how to achieve the target outcome change by adjusting the input features
(counterfactual reasoning), [feature shape](explanatory_form.md#fs) and [feature
interaction](explanatory_form.md#fi) allow users to adjust features and
...
### Preferred explanatory forms
While [output](explanatory_form.md#output)
(21/46) and [performance](explanatory_form.md#performance) (17/46) provide AI's
result and help to [build trust](#trust), [feature
attribute](explanatory_form.md#fa) (27/46) and [decision
tree](explanatory_form.md#dt) (17/46) show the breakdown factors and
...
### Preferred explanatory forms
[Rule](explanatory_form.md#rl)(12/14),
[decision flow chart](explanatory_form.md#dt)(7/14), and [feature
attribute](explanatory_form.md#fa)(5/14) are the most frequently selected
explanatory forms.
...
> *"[Rule](explanatory_form.md#) is just describing and writing. It
doesn't really show you a visual on how to compare them."* 

> *"[Feature attribute](explanatory_form.md#fa) and [decision flow
chart](explanatory_form.md#dt) (presented in image format on bird
recognition task) highlights what [rule](explanatory_form.md#rl) is
